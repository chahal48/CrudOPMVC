...
namespace CrudOPMVC.Models
{
    public class ProfessionModel
    {
        ...
        //[Remote("IsProfessionAvailable", "Profession", HttpMethod = "POST", ErrorMessage = "Profession already in use.")]
        [Remote("IsProfessionAvailable", "Profession", HttpMethod = "Post", ErrorMessage = "Profession already exist.", AdditionalFields = "initialProfession")]
